...
object Versions {
    ...
    const val gradleBuildTool = "4.1.1"
...
object Dependencies {
    ...
    const val kotlin_coroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-android:${Versions.kotlinCoroutineVersion}"
    const val kotlin_lifecycle_viewModel = "androidx.lifecycle:lifecycle-viewmodel-ktx:${Versions.kotlinLifecycleVersion}"
    const val kotlin_lifecycle_livedata = "androidx.lifecycle:lifecycle-livedata-ktx:${Versions.kotlinLifecycleVersion}"
