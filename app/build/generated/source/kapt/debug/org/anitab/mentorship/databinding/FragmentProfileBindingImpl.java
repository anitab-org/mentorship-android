...
public class FragmentProfileBindingImpl extends FragmentProfileBinding  {
    ...
    private androidx.databinding.InverseBindingListener etUserNameandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        ...
        public void onChange() {
            ...
            // user
            org.anitab.mentorship.models.User user = mUser;
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.user == variableId) {
            setUser((org.anitab.mentorship.models.User) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUser(@Nullable org.anitab.mentorship.models.User User) {
        this.mUser = User;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
