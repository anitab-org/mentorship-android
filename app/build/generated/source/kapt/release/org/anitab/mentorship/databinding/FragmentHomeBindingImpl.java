...
import org.anitab.mentorship.BR;
...
public class FragmentHomeBindingImpl extends FragmentHomeBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.stats == variableId) {
            setStats((org.anitab.mentorship.models.HomeStatistics) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setStats(@Nullable org.anitab.mentorship.models.HomeStatistics Stats) {
        this.mStats = Stats;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        org.anitab.mentorship.models.HomeStatistics stats = mStats;
    ...
    /* flag mapping
        ...
        flag 4 (0x5L): stats != null ? String.valueOf(stats.pendingRequests) : String.valueOf(0)
        flag 5 (0x6L): stats != null ? String.valueOf(stats.pendingRequests) : String.valueOf(0)
        flag 6 (0x7L): stats != null ? String.valueOf(stats.completedRelations) : String.valueOf(0)
        flag 7 (0x8L): stats != null ? String.valueOf(stats.completedRelations) : String.valueOf(0)
        flag 8 (0x9L): stats != null ? String.valueOf(stats.acceptedRequests) : String.valueOf(0)
        flag 9 (0xaL): stats != null ? String.valueOf(stats.acceptedRequests) : String.valueOf(0)
        flag 10 (0xbL): stats != null ? String.valueOf(stats.rejectedRequests) : String.valueOf(0)
        flag 11 (0xcL): stats != null ? String.valueOf(stats.rejectedRequests) : String.valueOf(0)
    flag mapping end*/
    //end
}