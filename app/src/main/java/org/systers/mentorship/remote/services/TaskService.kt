...
interface TaskService {
    ...
    /**
     * This function marks the task as completed in a mentorship relation
     * @param requestId id of the mentorship relation in question
     * @param taskId id of a task within a mentorship relation
     * @return an Observable of a list of [Task]
     */
