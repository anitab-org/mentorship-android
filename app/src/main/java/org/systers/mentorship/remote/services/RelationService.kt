...
interface RelationService {
    ...
    fun getAllRelationships(): CustomObservable<List<Relationship>>
    ...
    fun getAllPendingRelationships(): CustomObservable<List<Relationship>>
    ...
    fun getPastRelationships(): CustomObservable<List<Relationship>>
    ...
    fun acceptRelationship(@Path("relation_id") relationId: Int): CustomObservable<CustomResponse>
    ...
    fun rejectRelationship(@Path("relation_id") relationId: Int): CustomObservable<CustomResponse>
    ...
    fun deleteRelationship(@Path("relation_id") relationId: Int): CustomObservable<CustomResponse>
    ...
    fun cancelRelationship(@Path("relation_id") relationId: Int): CustomObservable<CustomResponse>
    ...
    fun sendRequest(@Body relationshipRequest: RelationshipRequest): CustomObservable<CustomResponse>
