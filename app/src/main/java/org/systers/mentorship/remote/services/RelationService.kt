...
interface RelationService {
    ...
    fun getAllRelationships(): Simple<List<Relationship>>
    ...
    fun acceptRelationship(@Path("relation_id") relationId: Int): Simple<CustomResponse>
    ...
    fun rejectRelationship(@Path("relation_id") relationId: Int): Simple<CustomResponse>
    ...
    fun deleteRelationship(@Path("relation_id") relationId: Int): Simple<CustomResponse>
    ...
    fun cancelRelationship(@Path("relation_id") relationId: Int): Simple<CustomResponse>
    ...
    fun sendRequest(@Body relationshipRequest: RelationshipRequest): Simple<CustomResponse>
