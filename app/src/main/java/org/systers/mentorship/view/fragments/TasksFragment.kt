                ...
                if (successful) {
                    if (taskViewModel.tasksList.isEmpty()) {
                        ...
                        rvTasks.apply {
                            ...
                            adapter = TasksAdapter(requireContext(),taskViewModel.incompleteTasksList(), ::markTask, false, mentorshipRelation)
                        }
                        ...
                        if (completeTasksList.isNotEmpty()){
                            rvAchievements.apply {
                                layoutManager = LinearLayoutManager(context)
                                adapter = TasksAdapter(requireContext(),completeTasksList, ::markTask, true, mentorshipRelation)
                            }
