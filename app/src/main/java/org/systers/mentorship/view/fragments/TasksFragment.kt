...
class TasksFragment(private var mentorshipRelation: Relationship) : BaseFragment() {
                ...
                if (successful) {
                    if (taskViewModel.tasksList.isEmpty()) {
                        ...
                        rvTasks.apply {
                            ...
                            adapter = TasksAdapter(context!!,taskViewModel.tasksList, ::markTask, false)
                        }
                        tvNoTask.visibility = View.GONE

                        val completeTasksList = taskViewModel.tasksList
    ...
    private fun showCompleteDialog() {
        ...
        builder.setPositiveButton(appContext.getString(R.string.save)) { _, _ ->
            ...
            taskViewModel.addTask(mentorshipRelation.id, editTextAddTask.text.toString())
        }
    ...
    private fun markTask(taskId: Int){
        taskViewModel.updateTask(taskId, mentorshipRelation.id, true)
    }
}
