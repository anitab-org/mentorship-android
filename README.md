...
* A member can read and know more about the Mentorship System including the [terms and conditions](https://anitab.org/terms-of-use/), [privacy and policy](https://anitab.org/privacy-policy/), and [code of conduct](https://ghc.anitab.org/code-of-conduct/).
* A member can directly access the [AnitaB-org Github repo](https://github.com/anitab-org/mentorship-android), [Zulip chat](https://anitab-org.zulipchat.com/), and [website](https://anitab-org.github.io/) from this App.
